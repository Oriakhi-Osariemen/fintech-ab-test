...
Related project
The SQL schema and analytical patterns in this project complement the companion project: pharma-inventory-sql — a separate SQL portfolio project demonstrating inventory analytics.

Author
Osariemen Oriakhi — Data & Finance Analyst, Paris LinkedIn · GitHub# fintech-ab-test
End-to-end A/B test analysis for a fintech loan application form — experiment design, SQL segmentation, Python z-test, power analysis, and business recommendation.
